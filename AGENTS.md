...
- **Interfaces after Constants:** Moved Interfaces section to right after Constants (before Config).
...
- **Section ordering:** Paths → Constants → Interfaces → Config → Logger → Storage → Helpers → Plugin.
